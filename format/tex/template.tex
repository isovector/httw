...
Copyright \textcopyright 2022, Sandy Maguire
...
\settowidth\longest{\Large the poet and the mathematician}
\bigQuote{G. K. Chesterton}{
  The difference between\\
  the poet and the mathematician\\
  is that the poet tries\\
  to get his head into the heavens\\
  while the mathematician tries\\
  to get the heavens into his head.
}
